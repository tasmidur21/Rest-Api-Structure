...
const validationSchema = yup.object().shape({
    ...
    confirm_password: yup.string()
        .notRequired('Confirm Password is required')
        .oneOf([yup.ref('password')], 'Passwords must match')
});

const UserEdit = ({show, modalTitle, editableData, handleClose, onSubmitHandler}) => {
                                        ...
                                        <Col className="pr-1" md="6">
                                            <Form.Group>
                                                ...
                                                <Form.Select className="form-control"
                                                             defaultValue={editableData?.user_type}
                                                             {...register("user_type")}
                                                >
                                    ...
                                    <Row>
                                        ...
                                        <Col className="pl-1" md="6">
                                            <Form.Group>
                                                ...
                                                <Form.Control
                                                    defaultValue={editableData?.phone_number}
